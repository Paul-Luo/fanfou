...
CREATE TABLE IF NOT EXISTS `FANFOU`.`CUSTOMER_ORDER` (
  ...
  `USER_ID` BIGINT(20) NULL COMMENT '',
  `ORDER_STATE` VARCHAR(45) NULL COMMENT '',
  `CREATED_DATETIME` TIMESTAMP NOT NULL DEFAULT '2015-08-18 00:00:00' COMMENT '',
  `UPDATED_DATETIME` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '',
...
CREATE TABLE IF NOT EXISTS `FANFOU`.`ORDER_DETAIL` (
  `DETAIL_ID` BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT '',
...
-- -----------------------------------------------------
-- Table `FANFOU`.`STATION`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `FANFOU`.`STATION` (
  `ID` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `STATION_NAME` VARCHAR(255) NULL COMMENT '',
  `LON` FLOAT NULL COMMENT '',
...
-- Table `FANFOU`.`LINE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `FANFOU`.`LINE` (
  `LINE_NUMBER` INT NOT NULL COMMENT '',
  `STATION_ID` INT NULL COMMENT '',
  `ARRIVAL_TIME` TIME NULL COMMENT '',
  INDEX `FK_LINE_STATION_idx` (`STATION_ID` ASC)  COMMENT '')
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `FANFOU`.`FEEDBACK`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `FANFOU`.`FEEDBACK` (
  `ID` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `USER_ID` BIGINT(20) NULL COMMENT '',
...
USE `FANFOU`$$
CREATE DEFINER = CURRENT_USER TRIGGER `FANFOU`.`FEEDBACK_BEFORE_INSERT` BEFORE INSERT ON `FEEDBACK` FOR EACH ROW
BEGIN
	SET NEW.CREATED_DATETIME = NOW();
END
$$
