...
<header class="main-header">
    ...
    <a href="" class="logo">
        ...
        <span class="logo-mini"><b>Fan</b>fou</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Fan</b>Fou</span>
    </a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#">
                        ...
                        <%--<img src="<c:url value='/resources/common/AdminLTE/img/user2-160x160.jpg' />" class="user-image" alt="User Image">--%>
