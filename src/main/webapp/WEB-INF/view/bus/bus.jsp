...
<%--<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=DCf3f0048707ea9d4703f451d16e6359"></script>--%>
<button class="btn btn-info" data-toggle="control-sidebar">The Wrong Place?</button>
<div id="allMap"></div>

<script type="text/javascript">

    $.getScript("http://api.map.baidu.com/getscript?v=2.0&ak=DCf3f0048707ea9d4703f451d16e6359&services=&t=20150824103311", function(){
        $(function () {
